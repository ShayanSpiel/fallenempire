-- Ensure battle participation does not grant rage (adrenaline replaces old logic)
-- Date: January 6, 2027
...
-- Recreate record_battle_participation WITHOUT any rage logic
...
'Records battle participation and updates user stats. Rage on fight removed; adrenaline handles bonuses.';
