-- ============================================================================
-- ADD SINGLE SOURCE OF TRUTH: display_name column
-- ============================================================================
-- This migration adds display_name to world_regions which is ALWAYS non-null
-- and automatically computed, eliminating scattered fallback logic everywhere.
-- ============================================================================
